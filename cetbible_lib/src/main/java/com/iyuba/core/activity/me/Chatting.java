...
import com.iyuba.core.adapter.me.ChattingAdapter;
...
public class Chatting extends BasisActivity {
    ...
    private String friendid, currentname = null;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    chatContent.setSelection(msg.arg1 - 1);
                    break;
                case 5:
                    ...
                    emotion_GridView
                            .setOnItemClickListener(new OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> arg0,
                                    ...
                                    String str = Emotion.express[arg2];
