 ...
 * @author 陈彤
 */
public class PullToRefreshView_New extends LinearLayout {
    // refresh states
    ...
    public PullToRefreshView_New(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PullToRefreshView_New(Context context) {
        super(context);
        init();
    }
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.refresh_header_new, this, false);
...
//				.findViewById(R.id.pull_to_refresh_updated_at);
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(R.layout.refresh_footer_new, this, false);
...
//	}
    ...
    public interface OnFooterRefreshListener {
        void onFooterRefresh(PullToRefreshView_New view);
    }
    ...
    public interface OnHeaderRefreshListener {
        void onHeaderRefresh(PullToRefreshView_New view);
    }
}
