...
public class SnackBar {
    ...
    public SnackBar(Activity activity) {
        ...
        ViewGroup container = activity
                .findViewById(android.R.id.content);
        View v = activity.getLayoutInflater().inflate(R.layout.sb__snack,
                container);
        init(v);
    }
    ...
    private void init(View v) {
        ...
        mSnackMsg = v.findViewById(R.id.snackMessage);
        mSnackBtn = v.findViewById(R.id.snackButton);
    ...
    public SnackBar show(String message, String actionMessage,
                         Style actionStyle, int actionIcon) {
        show(message, actionMessage, actionStyle, actionIcon, null);
        return this;
    }

    public SnackBar show(String message, String actionMessage, int actionIcon,
                         Parcelable token) {
    ...
    public SnackBar show(String message, String actionMessage,
                         Style actionStyle, int actionIcon, Parcelable token) {
    ...
    public SnackBar show(String message, String actionMessage, int textColor,
                         int actionIcon, Parcelable token, short duration) {
        ColorStateList color = mContext.getResources().getColorStateList(
                textColor);
        Snack m = new Snack(message,
                (actionMessage != null ? actionMessage.toUpperCase() : null),
    ...
    public SnackBar show(String message, String actionMessage, Style style,
                         int actionIcon, Parcelable token, short duration) {
        Snack m = new Snack(message,
                (actionMessage != null ? actionMessage.toUpperCase() : null),
                actionIcon, token, duration, style);
        if (isShowing()) {
            mSnacks.push(m);
        } else {
            show(m);
    ...
    public SnackBar show(int message, int actionMessage, int actionIcon,
                         Parcelable token) {
        show(message, actionMessage, Style.DEFAULT, actionIcon, token);
        return this;
    }
    ...
    public SnackBar show(int messageResId, int actionMessageResId,
                         int textColor, int actionIcon, Parcelable token, short duration) {
        ColorStateList color = mContext.getResources().getColorStateList(
                textColor);
    ...
    public SnackBar show(int messageResId, int actionMessageResId, Style style,
                         int actionIcon, Parcelable token, short duration) {
        String message = mContext.getString(messageResId);
        String actionMessage = null;
        if (actionMessageResId > 0) {
    ...
    public int getHeight() {
        mContainer.measure(View.MeasureSpec.makeMeasureSpec(
    ...
    private ColorStateList getActionTextColor(Style style) {
        switch (style) {
            ...
            case CONFIRM:
                return mContext.getResources().getColorStateList(
                        R.color.sb__button_text_color_green);
            case DEFAULT:
                return mContext.getResources().getColorStateList(
    ...
    private void show(Snack message, boolean immediately) {
        ...
        if (message.mActionMessage != null) {
            ...
            mSnackBtn.setCompoundDrawablesWithIntrinsicBounds(
    ...
    public SnackBar setOnVisibilityChangeListener(
