...
public class QuestionListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.quesRecommend = convertView
                    .findViewById(R.id.iv_ques_recommend);
            viewHolder.quesIcon = convertView
                    .findViewById(R.id.ques_icon);
            viewHolder.quesName = convertView
                    .findViewById(R.id.ques_name);
            viewHolder.quesInfo = convertView
                    .findViewById(R.id.ques_info);
            viewHolder.answerIcon = convertView
                    .findViewById(R.id.answer_icon);
            viewHolder.isAnswer = convertView
                    .findViewById(R.id.is_answer);
            viewHolder.answerName = convertView
                    .findViewById(R.id.answer_name);
            viewHolder.quesDisc = convertView
                    .findViewById(R.id.ques_disc);
            viewHolder.quesPic = convertView
                    .findViewById(R.id.ques_pic);
            viewHolder.quesSource = convertView
                    .findViewById(R.id.ques_source);
            viewHolder.answerNum = convertView
                    .findViewById(R.id.answer_num);
            viewHolder.commentNum = convertView
                    .findViewById(R.id.comment_num);
            viewHolder.agreeNum = convertView
                    .findViewById(R.id.agree_num);
            viewHolder.user_inf = convertView.findViewById(R.id.user_inf);
            viewHolder.agree = convertView.findViewById(R.id.agree);
        ...
        viewHolder.agree.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (checkAgree("q" + mList.get(position).getQuestionid(),
                        AccountManager.Instace(mContext).getId()) == 1) {
                    ...
                    ExeProtocol.exe(
                            new AgreeAgainstRequest(AccountManager
                                    ...
                                    .Instace(mContext).getUserName(), "questionid",
                    ...
                    new CommentAgreeOp(mContext).saveData(
                            ...
                            AccountManager.Instace(mContext).getId(), "agree");
        ...
        viewHolder.quesName.setText((TextUtils.isEmpty(ques.getUsername()) || "null".equals(ques.getUsername())) ?
                ques.getUid() : ques.getUsername());
