...
public final class Downloads implements BaseColumns {
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = Constant.PERMISSION_ACCESS;
    /**
     * The permission to access the download manager's advanced functions
     *
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = Constant.PERMISSION_ACCESS_ADVANCED;
    /**
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = Constant.PERMISSION_SEND_INTENTS;
    /**
