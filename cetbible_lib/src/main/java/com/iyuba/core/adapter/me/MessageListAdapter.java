...
public class MessageListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mList.get(position).lastmessage = Emotion
                .replace(mList.get(position).lastmessage);
        SpannableString spannableString = Expression.getExpressionString(
                mContext, mList.get(position).lastmessage, zhengze);
        viewHolder.messageletter_lastmessage.setText(spannableString);
