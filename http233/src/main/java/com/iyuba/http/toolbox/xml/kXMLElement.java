...
public class kXMLElement {
     ...
     * @throws nanoxml.kXMLParseException if an error occured while parsing the read data
     */
     ...
     *
     * @throws nanoxml.kXMLParseException if an error occured while parsing the string
     */
     ...
     * @throws nanoxml.kXMLParseException if an error occured while parsing the array
     */
