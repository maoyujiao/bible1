 ...
 * @name bible
 * @class name：com.iyuba.CET4bible.util
 * @class describe
 * @time 2018/10/17 14:35
 * @change
 * @chang time
 * @class describe
 */
...
public class ShareUtil {
    ...
    private static com.iyuba.core.me.fragment.ShareUtil.OnShareStateListener onShareStateListener;

    public static void setOnShareStateListener(com.iyuba.core.me.fragment.ShareUtil.OnShareStateListener onShareStateListener) {
        com.iyuba.core.me.fragment.ShareUtil.onShareStateListener = onShareStateListener;
    }
